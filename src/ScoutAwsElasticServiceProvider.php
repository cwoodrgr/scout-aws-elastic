...
namespace Ruger\ScoutAwsElastic;
...
class ScoutAwsElasticServiceProvider extends ScoutElasticServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../Config/scout_elastic_aws.php' => config_path('scout_elastic_aws.php'),
        ]);
    }
    ...
    protected function awsConnection(): void
    {
        $this
            ...
            ->singleton('scout_elastic.client', function () {
                $config = Config::get('scout_elastic_aws.connections.default');
    ...
    protected function standardConnection(): void
    {
        $this
            ->app
            ->singleton('scout_elastic.client', function () {
                $config['hosts'] = collect(Config::get('scout_elastic_aws.connections.default.hosts'))
                    ->map(function ($host) {
